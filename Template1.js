...
const Template1 = forwardRef(({ information, sections }, ref) => {
  ...
  const defaults = {
    ...
    workExp: [
      {
        ...
        endDate: "2023-01-01",
        location: "City, India",
        points: ["Did something impactful", "Improved performance by 30%"],
      },
    ],
    ...
    project: [
      {
        ...
        points: ["Built using React", "Implemented API integration"],
      },
    ],
    ...
    achievements: ["Won hackathon", "Top performer award"],
    others: "Add languages, hobbies, interests etc.",
  };
  ...
  return (
    <div ref={ref} className={styles.container}>
      ...
      <div className={styles.headerCard}>
        <h1>
          {info.basicInfo?.detail?.name || defaults.name}
        </h1>
        <p>
